...
double angle=pi/8;//угол раствора стрелки       //длина кончика стрелки
int disp=40;      //разброс подписей ребер
/*vector<vector<int>> mat={{0, 0, 11, 26, 0, 12},
                         {0, 0, 17, 20, 0, 0},
                         {0, 0, 0, 0, 15, 0},
                         {0, 0, 0, 0, 38, 0},
                         {0, 0, 0, 0, 0, 23},
...
myPainter::myPainter()
{
    ...
    back=QBrush(QColor(220,220,220));
    textPen=QPen(QColor(100, 149, 237));
